...
The new domain primitives do not change the currently available XRP Testnet product surface. Runtime availability remains the current XRP Testnet implementation until corresponding feature PRs are merged and tested.
